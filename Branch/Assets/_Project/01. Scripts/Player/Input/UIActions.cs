...
//     version 1.14.2
//     from Assets/_Project/01. Scripts/Player/Input/UIActions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/_Project/01. Scripts/Player/Input/UIActions.inputactions".
/// </summary>
/// <remarks>
...
public partial class @UIActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""UIActionMap"",
            ""id"": ""bac484b5-69c9-46b4-8151-f05803c9418e"",
            ""actions"": [
                {
                    ""name"": ""NextDialogue"",
                    ""type"": ""Button"",
                    ""id"": ""bd8e7100-8927-4c18-99f2-897d68b2d05c"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""62abbb45-8588-4698-96c8-a206cb661ee4"",
    ...
    ~@UIActions()
    {
        UnityEngine.Debug.Assert(!m_UIActionMap.enabled, "This will cause a leak and performance issues, UIActions.UIActionMap.Disable() has not been called.");
    }
    ...
    public struct UIActionMapActions
    {
        ...
        /// </summary>
        public UIActionMapActions(@UIActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
